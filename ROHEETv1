...
def menu(my_name,my_id):
	...
	linex()
	_____rohiteyyy_____ = input(' CHOOSE : ')
	if _____rohiteyyy_____ in ['1']:
		harry_public()
	elif _____rohiteyyy_____ in ['2']:
		fileopt()
	elif _____rohiteyyy_____ in ['3','03']:
	rohiteyyypassask()
		results()
	elif _____rohiteyyy_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____rohiteyyy_____ in ['5','05']:
		contact()
	elif _____rohiteyyy_____ in ['0']:
		passask()
...
def harryresults():
    ok_file_path = '/sdcard/ROHEETv1/ROHEETv1-OK.txt'
    cp_file_path = '/sdcard/ROHEETv1/ROHEETv1-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/rohitdon7)
